...
# class integer. This method transforms the input into numeric values and then
...
# date, and transformed back into integer.

# Input:
#     SymptomOnset  - an nx1 integer vector, where n is the number of cases
