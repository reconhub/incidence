...
##'
##' Two functions can be used to subset incidence objects.  The function \code{subset} permits to
##' retain dates within a specified range and, optionally, specific groups. The operator "[" can be
##' used as for matrices, using the syntax \code{x[i,j]} where 'i' is a subset of dates, and 'j' is
##' a subset of groups.
##'
