#' Method for input of class list.
#'
#' This is the method that is used when the input into incidence() is of the
#' class list.
#'
#' This method prints a warning if the list has more than one members. It then
#' takes the first member and re-runs incidence, which will choose a method
#' according to the class of the first member of the input.
#'
