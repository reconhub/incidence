...
#' incidence is on day 1. incidenceComputation is then used to compute the number
#' of incidents per interval. This result is then again shifted back to the
#' original starting date, and transformed back into POSIXlt.
#' 
