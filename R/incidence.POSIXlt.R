#' Method for input of class POSIXlt.
#'
...
#' by 24*60*60 because as.numeric() of a POSIXlt value gives the number of
...
#'
#' @param SymptomOnset An nx1 vector of class POSIXlt, where n is the number of
#'   cases
